...
.PHONY: build build_linux build_linux_arm64 build_win build_mac_amd64 build_mac_arm64 tag_checked_out mostlyclean

all:
	@echo choose a target from: build build_linux build_linux_arm64 build_win build_mac_amd64 build_mac_arm64 mostlyclean
	@echo prepend \`make BUILDTAG=1\` to checkout the highest git tag before building
	@echo or set BUILDTAG to a specific tag

# Build all binaries
build: build_linux build_linux_arm64 build_win build_mac_amd64 build_mac_arm64
...
build_linux build_linux_arm64 build_win build_mac_amd64 build_mac_arm64: tag_checked_out
endif
...
build_linux build_linux_arm64 build_win build_mac_amd64 build_mac_arm64:
...
DISTDIR := csaf-$(SEMVER)
dist: build_linux build_linux_arm64 build_win build_mac_amd64 build_mac_arm64
	mkdir -p dist
