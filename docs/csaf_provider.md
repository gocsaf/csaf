...
[provider_metadata]
# Optional RFC 3339 timestamps for the maintenance window of this distribution.
#maintained_from = "2026-01-01T00:00:00Z"
#maintained_until = "2027-01-01T00:00:00Z"
...
[provider_metadata.publisher.contact]
details = "Example Company can be reached via our website at https://www.example.com/contact."
email = "contact_us@example.com"
public_openpgp_key_url = "https://example.com/.well-known/openpgpkey/example.com/hu/example"
```
