...
import (
	"external/certcc.github.io/SSVC/data/schema/v2/SelectionList_2_0_0.schema"
	"external/www.first.org/cvss/cvss-v2.0"
	"external/www.first.org/cvss/cvss-v3.0"
	"external/www.first.org/cvss/cvss-v3.1"
	"external/www.first.org/cvss/cvss-v4.0"
...
// Category2 Defines the category of relationship between the previous item and the referenced next product.
type Category2 string

const (
	Category2DEFAULT_COMPONENT_OF Category2 = "default_component_of"
	Category2EXTERNAL_COMPONENT_OF Category2 = "external_component_of"
	Category2INSTALLED_ON Category2 = "installed_on"
	Category2INSTALLED_WITH Category2 = "installed_with"
	Category2OPTIONAL_COMPONENT_OF Category2 = "optional_component_of"
)
...
// $schema2 Contains the URL of the CSAF JSON schema which the document promises to be valid for.
type $schema2 string

const (
	$schema2HTTPS://DOCS_OASIS_OPEN_ORG/CSAF/CSAF/V2_1/SCHEMA/CSAF_JSON $schema2 = "https://docs.oasis-open.org/csaf/csaf/v2.1/schema/csaf.json"
)
...
// Category3 Provides information about the category of publisher releasing the document.
type Category3 string

const (
	Category3COORDINATOR Category3 = "coordinator"
	Category3DISCOVERER Category3 = "discoverer"
	Category3MULTIPLIER Category3 = "multiplier"
	Category3OTHER Category3 = "other"
	Category3TRANSLATOR Category3 = "translator"
	Category3USER Category3 = "user"
	Category3VENDOR Category3 = "vendor"
)
...
type Content struct {
	CvssV2 *JSONSchemaForCommonVulnerabilityScoringSystemVersion20 `json:"cvss_v2,omitempty"`
	// Can be one of: JSONSchemaForCommonVulnerabilityScoringSystemVersion30, JSONSchemaForCommonVulnerabilityScoringSystemVersion31
	CvssV3 *any `json:"cvss_v3,omitempty"`
	CvssV4 *JSONSchemaForCommonVulnerabilityScoringSystemVersion40,Revision2 `json:"cvss_v4,omitempty"`
	...
	SsvcV2 *SelectionList `json:"ssvc_v2,omitempty"`
...
// Category4 Specifies the category which this remediation belongs to.
type Category4 string

const (
	Category4FIX_PLANNED Category4 = "fix_planned"
	Category4MITIGATION Category4 = "mitigation"
	Category4NO_FIX_PLANNED Category4 = "no_fix_planned"
	Category4NONE_AVAILABLE Category4 = "none_available"
	Category4OPTIONAL_PATCH Category4 = "optional_patch"
	Category4VENDOR_FIX Category4 = "vendor_fix"
	Category4WORKAROUND Category4 = "workaround"
)

// Category5 Specifies what category of restart is required by this remediation to become effective.
type Category5 string

const (
	Category5CONNECTED Category5 = "connected"
	Category5DEPENDENCIES Category5 = "dependencies"
	Category5MACHINE Category5 = "machine"
	Category5NONE Category5 = "none"
	Category5PARENT Category5 = "parent"
	Category5SERVICE Category5 = "service"
	Category5SYSTEM Category5 = "system"
	Category5VULNERABLE_COMPONENT Category5 = "vulnerable_component"
	Category5ZONE Category5 = "zone"
)
...
// Category6 Categorizes the threat according to the rules of the specification.
type Category6 string

const (
	Category6EXPLOIT_STATUS Category6 = "exploit_status"
	Category6IMPACT Category6 = "impact"
	Category6TARGET_SET Category6 = "target_set"
)
...
type ThreatsItem struct {
	...
	Category Category6 `json:"category" validate:"required"`
...
type CommonSecurityAdvisoryFramework struct {
	...
	FSchema $schema2 `json:"$schema" validate:"required"`
